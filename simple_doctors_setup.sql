-- Simple setup script to avoid foreign key issues
...
-- Step 3: Add doctor_id column (without foreign key constraint for now)
DO $$ 
BEGIN
...
-- Step 4: Set default doctor for existing entries
